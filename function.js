...
function calculateTip(_tipPercent,_bill){
    let tip =tipPercent*bill;
    console.log(tip);

    calculateTip(0.20,20);
    calculateTip(0.25,50);
...
function calculateTip2(){
    let tipPercent= prompt("Enter the Percent you will tip between 0 and 1");
...
function applyDiscount(OriginalPrice,discountPercent){
    ...
    var newprice=OriginalPrice-discountPercent;
...
let discountPercent=prompt("Enter discounted percentage(between 0 and 1)");
var discountedAmount=originalPrice*discountPercent;
var newprice=originalPrice-discountedAmount;
alert("Updated price is "+ newprice);
}
